            ...
            children: [
              Container(
                ...
                child: UserAccountsDrawerHeader(
                  ...
                  accountEmail:User().email.isNotEmpty? Text(User().email):GestureDetector(onTap:(){Navigator.pushNamed(context, "/login");},child: Text("Login",style:TextStyle(fontSize:20,fontWeight: FontWeight.bold),)) ,
